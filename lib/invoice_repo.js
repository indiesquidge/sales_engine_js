...
InvoiceRepository.prototype.findAllInvoicesByMerchantId = function (id) {
  return this.all.filter(function (invoice) {
    return invoice.merchantId === id;
  });
};
...
InvoiceRepository.prototype.findInvoiceByCustomerId = function (id) {
  return this.parent.findInvoiceByCustomerId(id);
};

InvoiceRepository.prototype.findInvoiceByMerchantId = function (id) {
  return this.parent.findInvoiceByMerchantId(id);
};
